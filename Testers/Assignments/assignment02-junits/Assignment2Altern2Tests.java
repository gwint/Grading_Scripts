...
class Assignment2Altern2Tests {
	...
	void testYearsToBalance3() {
		...
		assertAll (
				() -> assertEquals(19, invest3.yearsToBalance(26500)),
	...
	void testWaitYears3() {
		...
		assertAll (
				...
				() -> assertEquals(29977.53, invest3.getBalance(),1e-2)
				);
	}
	...
	void testBalanceAfter3() {
		...
		double startBalance = invest3.getBalance();
		assertAll (
				() -> assertEquals(29977.53, invest3.balanceAfter(15),1e-2),
	...
	void testPortfolioWaitYears() {
		...
		assertAll (
				...
				() -> assertEquals(21175.66, invest3.getBalance(),1e-2),
				() -> assertEquals(13, invest3a.getYears()),
				() -> assertEquals(18240.89, invest3a.getBalance(),1e-2),
				() -> assertEquals(10, invest3b.getYears()),
				() -> assertEquals(16501.08, invest3b.getBalance(),1e-2)
				);
	}
